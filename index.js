...
app.post("/register", async(req, res)=>{
    try {
        ...
        res.status(201).json({message: "registration successful, please check your email for notification"});
    } catch(error){
...
// Get addresses  ✅ fixed: was POST, now GET
...
// Create order  ✅ fixed: shippingAddress field names now match order model
app.post("/orders", async(req, res)=>{
    try {
        ...
        // ✅ fixed: map frontend field names to order model field names
        const order = new Order({
            ...
            shippingAddress: {
                ...
                mobileNumber: shippingAddress?.mobileNumber || shippingAddress?.mobileNo || "",
                houseNo: shippingAddress?.houseNo || shippingAddress?.houseNumber || "",
